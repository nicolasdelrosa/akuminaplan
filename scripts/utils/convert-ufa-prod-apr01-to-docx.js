...
const markdownFile = path.join(__dirname, '..', '..', 'deployments', 'UFA', 'UFA_Prod_Deployment_Apr_01_2026_Release_Notes.md');
const outputFile = path.join(__dirname, '..', '..', 'deployments', 'UFA', 'UFA_Prod_Deployment_Apr_01_2026_Release_Notes.docx');
