...
// Convert March 6 DEV release notes
const devMarkdown = path.join(__dirname, '../../deployments/LASC/LASC_Dev_Deployment_Mar_06_2026_Release_Notes.md');
const devDocx = path.join(__dirname, '../../deployments/LASC/LASC_Dev_Deployment_Mar_06_2026_Release_Notes.docx');

convertMarkdownToDocx(devMarkdown, devDocx)
  .then(() => {
    console.log('\n✓ Release notes converted successfully!');
