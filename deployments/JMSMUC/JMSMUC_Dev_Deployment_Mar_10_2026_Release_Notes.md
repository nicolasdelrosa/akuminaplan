...
| **Branch** | `feature/dev-deployment-mar-10-2026` |
| **Pull Request** | TBD (Create after branch push) |
| **Pipeline** | JMSmuckers-Headless-Dev |
| **Deployment Ticket** | [JMSMUC-192](https://akumina.atlassian.net/browse/JMSMUC-192) |
| **Total Tickets** | 11 |
| **Manual Steps Required** | Yes (JMSMUC-186 requires manual steps) |
| **Release Label** | `dev-mar-10-2026` |

---

## Executive Summary

This deployment includes **2 critical NEW features** that must be deployed tonight, plus **9 catch-up tickets** from previous releases that were not successfully deployed. The release contains high-priority bug fixes, performance optimizations, and UI enhancements for the JM Smuckers development environment.
...
- [ ] Create feature branch: `feature/dev-deployment-mar-10-2026`
...
- [ ] Deployment ticket JMSMUC-192 created and approved
- [ ] All related tickets tagged with `dev-mar-10-2026` label
- [ ] Pull request created and approved
- [ ] Deployment window scheduled and communicated
- [ ] Rollback plan prepared and tested

### Pipeline Configuration
- [ ] JMSmuckers-Headless-Dev pipeline ready
...
git checkout feature/dev-deployment-mar-10-2026
git pull origin feature/dev-deployment-mar-10-2026
git log --oneline -10
...
2. Go to Pipelines → JMSmuckers-Headless-Dev
3. Click "Run pipeline"
4. Select branch: `feature/dev-deployment-mar-10-2026`
...
4. **Communication**
   ...
   - Update JMSMUC-192 ticket with rollback details
...
# Push fix
git push origin feature/dev-deployment-mar-10-2026
...
- **Jira**: https://akumina.atlassian.net/browse/JMSMUC-192
...
- [ ] Update JMSMUC-192 ticket with deployment results
...
### Ticket Links
- [JMSMUC-192 (Deployment Ticket)](https://akumina.atlassian.net/browse/JMSMUC-192)
