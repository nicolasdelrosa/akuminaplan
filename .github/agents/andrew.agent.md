...
- Before running any search/read/list command, keep scope pinned to `C:/Git/Akumina/DigitalWorkplace-Widgets/DigitalWorkplace-Widgets/Src`.
- Do not run workspace-wide searches.
- If evidence points to Core or AppManager ownership, stop searching outside scope and hand off to Jason or Udai.
- If user context is missing, ask for the widget area/path inside your scoped root before searching.
